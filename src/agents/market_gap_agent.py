...
[
  ...
  {
    "gap": "Missing integration with the popular 'Zapier' automation platform.",
    "impact": "Medium",
    "evidence": "The company profile lists integrations with Salesforce and Slack, but not Zapier. Three out of five competitors explicitly list Zapier integration as a key feature on their product pages.",
    "source": "Company Profile, Competitor List"
  }
]
"""
